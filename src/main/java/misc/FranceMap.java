...
public class FranceMap {
    ...
    private static FranceMap instance;
    private Map<String , Field> fields = new HashMap<String, Field>(1000);
    private String fileName = "FR_CityCountryLatLon.csv";

    public static synchronized FranceMap getInstance() {
        if (instance == null) { instance = new FranceMap(); }
        return instance;
    }

    public FranceMap(){
        System.out.println("Recomputing FRANCE map!");
    try{
